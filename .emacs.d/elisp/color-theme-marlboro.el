...
(defun color-theme-marlboro ()
  "Color theme by Derek Bixler, created 2014-06-03."
  (interactive)
  (color-theme-install
 ...
 (font-lock-builtin-face ((t (:weight normal :foreground "#b81426"))))
 (font-lock-comment-delimiter-face ((t (:weight normal :inherit default))))
 (font-lock-comment-face ((t (:weight normal :foreground "#745e5e"))))
 (font-lock-constant-face ((t (:weight normal :foreground "#b81426"))))
 (font-lock-doc-face ((t (:weight normal :background "#f2f2f2" :inherit (font-lock-string-face)))))
 (font-lock-function-name-face ((t (:weight normal :foreground "#000000"))))
 (font-lock-keyword-face ((t (:weight normal :foreground "#b81426"))))
 ...
 (font-lock-type-face ((t (:weight normal :foreground "#b81426"))))
 (font-lock-variable-name-face ((t (:weight normal :foreground "#000000"))))
